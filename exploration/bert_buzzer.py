...
class BertBuzzer(Buzzer):
    ...
    def train(self):
        ...
        self.bert_model = BertForSequenceClassification.from_pretrained(self.bert_model_name).to(self.device)
        trainer = Trainer(
    ...
    def load(self):
        ...
        if os.path.exists(self.filename):
            self.bert_model = BertModel.from_pretrained(self.filename).to(self.device)
        else:
